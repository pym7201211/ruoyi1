 ...
 * @date 2019-11-19
 */
public class TokenXkstaffDepartments extends BaseEntity
{
    ...
    /** 维护时间 */
    @Excel(name = "维护时间", width = 30, dateFormat = "yyyyMMdd")
    ...
    public String toString() {
        return "TokenXkstaffDepartments{" +
                "deptId=" + deptId +
                ", id='" + id + '\'' +
                ", userId='" + userId + '\'' +
                ", userName='" + userName + '\'' +
                ...
                ", idCard='" + idCard + '\'' +
                ", orgCode='" + orgCode + '\'' +
                ", oneDeptOrg='" + oneDeptOrg + '\'' +
                ", twoDeptOrg='" + twoDeptOrg + '\'' +
