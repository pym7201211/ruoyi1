 ...
 * @date 2020-01-08
 */
public class UrgencyAlteratRegisters extends BaseEntity
{
    ...
    public UrgencyAlteratRegisters(
            /*Long id, */String systemName, String operatorId, String operator,String reviewerId,
            String reviewer, String orderNum, String urgencyDate, String executor, String startTime,
            String endTime, String urgencyFunDescribe, String cooperateItems, String codeAudit,
            String finishTheTest, String pressureTest, String businessOperation, String handbookUpdate,
            String riskDescribe, String sendBackScheme, String urgencySponsorDept, String internetUrgency,
            String securityTeam, String dataUrgency, String bigDataTeam, String involveSystem,
            String involveSystemIllustrate, String status, String orderNo, String teamCharge,
            String teamBranched, String chargeLeader, String manageStatus, String currentTask,
            String executorId,String teamBranchedId,String chargeLeaderId,String teamChargeId,
            String securityTeamId,String bigDataTeamId,String reviewerStatus) {
        //this.id = id;
        this.systemName = systemName;
        this.operatorId = operatorId;
        this.operator = operator;
